...
public enum Measure {
    ...
    DIVERSITY(DiversityEvaluator.class), // my
...
//            rankingEnumList.add(new MeasureValue(DIVERSITY, 5)); // my
//            rankingEnumList.add(new MeasureValue(DIVERSITY, 10)); // my
        } else {
...
//            rankingEnumList.add(new MeasureValue(DIVERSITY, topN)); // my
        }
