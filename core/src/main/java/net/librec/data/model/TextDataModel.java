...
//            System.out.println("inputDataPath " + i + " = "  + inputDataPath[i]);
//        }

    	// this is what was orignally working
//    	String[] inputDataPath = (System.getProperty("user.dir") + File.separator + conf.get(Configured.CONF_DFS_DATA_DIR)).split(" ");
//        for(int i = 0 ; i < inputDataPath.length; i ++){
//            inputDataPath[i]=inputDataPath[i] + File.separator + conf.get(Configured.CONF_DATA_INPUT_PATH);
////            System.out.println("inputDataPath " + i + " = "  + inputDataPath[i]);
//        }
